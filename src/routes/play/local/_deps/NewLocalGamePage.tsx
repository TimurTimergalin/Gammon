...
const InnerNewLocalGamePage = <Index, Prop>({ruleset}: LocalGamePageProps<Index, Prop>) => {
...
export const NewLocalGamePage = <Index, Prop>(props: LocalGamePageProps<Index, Prop>) => (
    <GameContextHolder>
        <InnerNewLocalGamePage {...props} />
    </GameContextHolder>
)